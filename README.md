...
```
cd existing_repo
git remote add origin https://gitlab.bioinf.nioo.knaw.nl/tomatomicrobiome/microQTL.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.bioinf.nioo.knaw.nl/tomatomicrobiome/microQTL/-/settings/integrations)
